...
procedure leerdeclaracion (var dinero,porcentaje,numminimo: integer;var minimoimpo: boolean; var tramo: char);
begin
...
function sirestardinero(dinero,numminimo: integer;minimoimpo: boolean): boolean;
begin
	result := ((minimoimpo) and (dinero >= numminimo)) or (not minimoimpo);
end;
...
function dineroexpolio(dinero,porcentaje,numminimo: integer; minimoimpo: boolean; tramo: char): integer;
begin
	if sirestardinero(dinero,numminimo,minimoimpo) then begin
...
function dinerocuidadano(dinero,porcentaje,numminimo: integer;minimoimpo: boolean;tramo: char): integer;
begin
	result := dinero - dineroexpolio(dinero,porcentaje,numminimo,minimoimpo,tramo);
end;
...
begin 
	leerdeclaracion(dinero,porcen,cantidadminimo,minimoimpo,tramo);
	escribirdeclaracion(dinero,porcen,cantidadminimo,minimoimpo,tramo);
	writeln('Dinero expoliado: ',dineroexpolio(dinero,porcen,cantidadminimo,minimoimpo,tramo));
	writeln('Dinero perteneciente al contribuyente: ',dinerocuidadano(dinero,porcen,cantidadminimo,minimoimpo,tramo));
end.
